...
@section('content')
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4 animate-fade-in-up">
        <div>
            ...
            <p class="text-gray-400 mt-1 text-sm">Kelompokkan aset Anda agar lebih terorganisir.</p>
        </div>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="border-b border-luxury-gold/10 text-luxury-gold uppercase text-xs tracking-widest bg-black/20">
                        <th class="p-6 font-semibold rounded-tl-[2rem]">Info Kategori</th>
                        <th class="p-6 font-semibold">Deskripsi</th>
                        ...
                        <tr class="hover:bg-luxury-gold/5 transition-colors group">
                            ...
                            <td class="p-6 text-right">
                                <div class="flex items-center justify-end gap-2 opacity-60 group-hover:opacity-100 transition-opacity">
                                    <a href="{{ route('categories.edit', $item->id) }}" class="p-2 rounded-lg hover:bg-luxury-gold/20 text-luxury-gold border border-transparent hover:border-luxury-gold/30 transition tooltip" title="Edit Data">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                    </a>
                                    <form action="{{ route('categories.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus kategori ini? Data aset terkait mungkin akan ikut terhapus!');">
                                        @csrf @method('DELETE')
                                        <button type="submit" class="p-2 rounded-lg hover:bg-red-500/10 text-red-400 hover:text-red-500 border border-transparent hover:border-red-500/30 transition tooltip" title="Hapus Data">
                        ...
                        <tr>
                            <td colspan="3" class="p-12 text-center text-gray-500">
                                <div class="flex flex-col items-center justify-center">
                                    <div class="w-16 h-16 bg-luxury-gold/5 rounded-full flex items-center justify-center mb-4">
                                        <svg class="w-8 h-8 text-luxury-gold/30" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4"></path></svg>
                                    </div>
